  ...
  return (
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              ...
              { name: "AutoSL", path: "/projects/autosl" },
            ]),
          ),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            caseStudySchema({ path: "/projects/autosl", name: "AutoSL" }),
          ),
        }}
      />
      ...
      */}
      ...
      <div className="container mx-auto px-5 py-10 lg:py-15">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div>
            <h1 className="text-5xl sm:text-6xl lg:text-8xl tracking-tight font-bold -mt-1 uppercase">AutoSL</h1>
          </div>
          <div>
      ...
      <div className="container mx-auto px-5">
        <div className="bg-white rounded-xl flex flex-col lg:flex-row items-center gap-8 lg:gap-25 my-10 lg:my-15 p-6 lg:pl-15 lg:pr-30 lg:py-10">
          ...
          <div className="w-full lg:flex-2">
            <p className="text-lg lg:text-xl text-[#0E3A90] leading-relaxed">Luxusfahrzeuge brauchen eine digitale Umgebung, die nicht verkauft wie ein Inserat, sondern präsentiert wie ein kuratiertes Sammlerstück.</p>
          </div>
        </div>
      </div>
