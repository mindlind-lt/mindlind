  ...
  return (
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              ...
              { name: "MUA Faktur", path: "/projects/muafaktur" },
            ]),
          ),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            caseStudySchema({ path: "/projects/muafaktur", name: "MUA Faktur" }),
          ),
        }}
      />
      ...
      */}
      ...
      <div className="container mx-auto px-5 py-10 lg:py-15">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div>
            <h1 className="text-5xl sm:text-6xl lg:text-8xl tracking-tight font-bold -mt-1 uppercase">MUA FAKTUR</h1>
          </div>
          <div>
        ...
        <div className="mt-10 lg:mt-15">
          <DoorButton className="w-full" href="https://muafaktur.de" target="_blank">WEBSITE ÖFFNEN</DoorButton>
        </div>
      ...
      <div className="container mx-auto px-5 py-10 lg:py-15 flex flex-col lg:flex-row gap-6 lg:gap-20">
        <h2 className="text-xl font-semibold flex-1 lg:max-w-50">Herausforderung / Prozess</h2>
