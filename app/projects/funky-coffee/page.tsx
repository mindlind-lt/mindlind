    ...
    <>
      ...
      <div className="container mx-auto px-5 py-15">
        ...
        <div className="grid grid-cols-2">
          <div>
            <h1 className="text-8xl tracking-tight font-bold -mt-1 uppercase">Funky Coffee</h1>
          </div>
          <div>
      ...
      <div className="container mx-auto px-5">
        <div className="bg-white rounded-xl flex items-center gap-25 my-15 pl-15 pr-30 py-10">
          ...
          <div className="flex-2">
            <p className="text-xl text-[#152F6A] leading-relaxed">Ein Café verkauft nicht nur Kaffee. Es verkauft Atmosphäre, Geschmack, Nähe und das Gefühl, einen Ort gefunden zu haben, an den man zurückkommen möchte.</p>
          </div>
        </div>
      </div>
