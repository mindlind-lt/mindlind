...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    // Use the first palette color as the base background so it actually appears in the output
    const baseColor = new THREE.Color(Array.isArray(colors) && colors.length ? colors[0] : '#000000');
    const bgVec4 = new THREE.Vector4(baseColor.r, baseColor.g, baseColor.b, 1);
