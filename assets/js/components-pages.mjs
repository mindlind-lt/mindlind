			...
			(Zr = ({
				...
				S2j9uFa1o: s ??
					u.S2j9uFa1o ?? {
						pixelHeight: 1672,
						pixelWidth: 3032,
						src: `/assets/images/IILGFHDcQECBZpzfU3sVdnZwN8.jpg`,
					},
...
function ri(e) {
	...
	let g = rUseMemo(() => (r.text || ``).split(``), [r.text]);
	c(() => {
...
function ji(e) {
	...
	E(ie, K);
	let q = rUseRef(null),
		J = rUseMemo(() => [{ current: null }, { current: null }], []),
		[ae, oe] = rUseState({ parent: null, children: null }),
		se = null,
		Y = [],
		ce = 0,
		le = 0;
	...
	(rUseRef(null), rUseRef(null), rUseRef(0));
	let pe = rUseRef(!1),
		me = w(),
		Z = rUseRef(null),
		he = rUseRef(null);
	...
	return re
		...
		: rJsxs(`section`, {
				style: Ri,
				children: [
					rJsx(`div`, { style: zi, children: `✨` }),
					rJsx(`p`, { style: Bi, children: `Connect to Content` }),
					rJsx(`p`, {
						style: Vi,
		...
		(C(),
			...
			(Ii = rForwardRef(({ children: e, ...t }, n) => {
				...
				return (
					...
					rJsx(`li`, { ...t, "aria-hidden": !i, ref: r, children: e })
				);
			})),
			(ji.defaultProps = {
				gap: 10,
			...
			(Ao = ({
				...
				a_b3bYSzg: n ??
					o.a_b3bYSzg ?? {
						...
						pixelHeight: 390,
						pixelWidth: 904,
						src: `/assets/images/JaRVOtDLWyzbmlq9DffwGhFiGEk.jpg`,
					},
		...
		(y(),
			...
			(Bs = ({
				...
				mFSRU4L0r:
					e ??
					o.mFSRU4L0r ??
					`Steigerung nach Relaunch und Optimierung der User Journey innerhalb von 90 Tagen.`,
				oOZL4Z7MG: r ?? o.oOZL4Z7MG ?? `Conversion rate`,
										...
										rJsx(R, {
											...
											children: rJsx(i, {
												children: rJsx(k.p, {
													...
													children: `Steigerung nach Relaunch und Optimierung der User Journey innerhalb von 90 Tagen.`,
												}),
											}),
			...
			P(Hs, {
				...
				mFSRU4L0r: {
					defaultValue: `Steigerung nach Relaunch und Optimierung der User Journey innerhalb von 90 Tagen.`,
					displayTextArea: !1,
					title: `Description`,
					type: J.String,
				},
...
function Sl(e) {
	return typeof e == `object` && !!e && !rIsValidElement(e) && El in e;
}
function Cl(e, ...t) {
	if (!e)
		throw Error(
		...
		(y(),
			...
			(Bu = ({
				...
				QujjwCxUD:
					t ??
					d.QujjwCxUD ??
					`Digitale Produkte mit messbarer Wirkung. Jedes Projekt verbindet Strategie, Design und Entwicklung zu klaren Ergebnissen — mit Fokus auf Performance, Nutzererlebnis und Wachstum.`,
				QvSNHBP5X: o ?? d.QvSNHBP5X ?? !0,
				ugJ8Iq0fa: a ?? d.ugJ8Iq0fa ?? `[03]`,
				uqZ2XSbpC: n ?? d.uqZ2XSbpC ?? `AUSGEWÄHLTE PROJEKTE`,
																				...
																				[
																					rJsx(
																						k.p,
																						{
																							...
																							children: `Digitale Produkte mit messbarer Wirkung. Jedes Projekt verbindet Strategie, Design und Entwicklung zu klaren Ergebnissen — mit Fokus auf Performance, Nutzererlebnis und Wachstum.`,
																						},
																					),
																					rJsx(
																						k.p,
																						...
																						children:
																							rJsx(
																								Us,
																								{
																									...
																									id: `kaYwfJkV7`,
																									layoutId: `kaYwfJkV7`,
																									mFSRU4L0r: `Steigerung nach Relaunch und Optimierung der User Journey innerhalb von 90 Tagen.`,
																									oOZL4Z7MG: `Conversion rate`,
																									RCWRhrHe8: `+34%`,
																									style: {
																										width: `100%`,
																									},
																						...
																						children:
																							rJsx(
																								Us,
																								{
																									...
																									id: `IA_A7ti1_`,
																									layoutId: `IA_A7ti1_`,
																									mFSRU4L0r: `Mehr Anfragen durch bessere Struktur, schnellere Ladezeiten und klare Kommunikation.`,
																									oOZL4Z7MG: `LEAD GENERIERUNG`,
																									RCWRhrHe8: `+41%`,
																									style: {
																										width: `100%`,
																									},
			...
			(Uu = Hu),
			(Hu.displayName = `AUSGEWÄHLTE PROJEKTE - Section`),
			...
			P(Hu, {
				...
				QujjwCxUD: {
					defaultValue: `Digitale Produkte mit messbarer Wirkung. Jedes Projekt verbindet Strategie, Design und Entwicklung zu klaren Ergebnissen — mit Fokus auf Performance, Nutzererlebnis und Wachstum.`,
					displayTextArea: !0,
					title: `Description`,
					type: J.String,
				},
...
function ed(e) {
	let {
		...
		w = rUseMemo(() => Yu(n, 600), [n]),
		T = rUseMemo(() => Zu(n, `fontSize`, `18px`), [n]),
		E = rUseMemo(() => Zu(n, `lineHeight`, `1.1`), [n]),
		O = rUseMemo(() => Zu(n, `letterSpacing`, `0px`), [n]),
		A = rUseMemo(() => Xu(n, `left`), [n]),
		j = rUseMemo(() => Qu(i), [i]),
		[M, N] = rUseState(t),
		P = D(),
		F = rUseMemo(() => t, [t]),
		I = rUseMemo(() => F.length, [F]),
		L = rUseMemo(() => Gu(I), [I]),
		R = rUseMemo(() => v.split(``), [v]);
	c(() => {
		ee.current || N(F);
	}, [F]);
											...
											children: [
												rJsx(se, {
													background: {
														...
														positionX: `center`,
														positionY: `top`,
														src: `/assets/images/yhlV6BFO3bhzXeyZiXDsNwf6E.svg`,
													},
												...
												rJsx(Z, {
													children: rJsx(H, {
														...
														children: rJsx(En, {
															...
															id: `tjqkO5hPa`,
															images: [
																`/assets/images/QmjNb5WuAsU8pA4OabSgTDdjZQ.jpg`,
																`/assets/images/LlBTpAra5dI0pBuu7EUc6IwFPM.jpg`,
																`/assets/images/bzmsEZLxMUpFBvYqK3HnRVAlzy8.jpg`,
																`/assets/images/hb7d24VUUMQx6CRiUhkYuK9UaWI.jpg`,
																`/assets/images/apdrGXNFA4sR4rckxD4vdggJbkk.jpg`,
															],
															layoutId: `tjqkO5hPa`,
															phaseStepDeg: 12.5,
															radius: 130,
	...
	qf = e(() => {
		(y(),
			...
			(Uf = ({
				...
				IyEnpMJn_: n ??
					c.IyEnpMJn_ ?? {
						...
						pixelHeight: 356,
						pixelWidth: 356,
						src: `/assets/images/sBQL5XuNYFmQDOH3Af1fncon8o.png`,
					},
				pN1QHQjCf: a ??
					c.pN1QHQjCf ?? {
						alt: ``,
						pixelHeight: 404,
						pixelWidth: 372,
						src: `/assets/images/p7oB50p8WqXZT97Rllw62Pfl8IM.png`,
					},
				...
				voZT7kFsz: r ??
					c.voZT7kFsz ?? {
						...
						pixelHeight: 288,
						pixelWidth: 289,
						src: `/assets/images/BijWSeC9c8hXz4aAcuCOPEuJvw.png`,
					},
			...
			P(Gf, {
				...
				pN1QHQjCf: {
					__defaultAssetReference: `data:framer/asset-reference,p7oB50p8WqXZT97Rllw62Pfl8IM.png`,
					__vekterDefault: {
						alt: ``,
						assetReference: `data:framer/asset-reference,p7oB50p8WqXZT97Rllw62Pfl8IM.png`,
					},
																						...
																						children:
																							rJsx(
																								In,
																								{
																									...
																									id: `aZ5uAgzSb`,
																									images: [
																										`/assets/images/S2IVnI63QsNhoslIUkEg2cLRac.jpg`,
																										`/assets/images/iuH6QoCVkOyINcIECFQTFq5ObA.jpg`,
																										`/assets/images/5AvFpUR4u3sU6UoMU6MtUVbJZQ.jpg`,
																										`/assets/images/qFl4cnO4pRr0RWWCqPJgGEcLzqM.jpg`,
																									],
																									imgRotateDeg:
																										-90,
																									layoutId: `aZ5uAgzSb`,
	...
	(y(),
		...
		(rm = z(
			rForwardRef(function (e, t) {
				...
				let [h, y] = me(f, Rp, !1),
					b = U(Bp),
					x = rUseContext(ge)?.isLayoutTemplate,
					C = Hp(x, !!rUseContext(A)?.transition?.layout);
				return (
					re(),
					Y({
						"1bj26gy": $p,
													...
													children: rJsx(ue, {
														...
														children: rJsx(ye, {
															...
															children: rJsx(Uu, {
																...
																layoutId: `GLS8Fanqv`,
																pZhrKeTu2: e[0],
																QujjwCxUD: `Digitale Produkte mit messbarer Wirkung. Jedes Projekt verbindet Strategie, Design und Entwicklung zu klaren Ergebnissen — mit Fokus auf Performance, Nutzererlebnis und Wachstum. Every case lists scope, timeline, stack and KPI movement with before and after. `,
																QvSNHBP5X: !0,
																style: {
																	width: `100%`,
																},
																ugJ8Iq0fa: `[03]`,
																uqZ2XSbpC: `AUSGEWÄHLTE PROJEKTE`,
																variant:
																	$(
																		`camO0iR5M`,
																	),
