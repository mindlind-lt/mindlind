...
import { r as le } from "./Vimeo.syDBXbah.mjs";
	...
	Ee = e(() => {
		(g(),
			...
			(be = ({ value: e, children: t }) => {
				...
				return d(S.Provider, { value: i, children: t });
			}),
			(xe = x.create(r)),
			(Se = {
...
function Rt({
	...
	return d(`button`, {
		...
		children: d(x.div, { style: { ...s, opacity: h } }),
	});
}
function zt() {
	return h(`section`, {
		style: Ut,
		children: [
			d(`div`, { style: Wt, children: `✨` }),
			d(`p`, { style: Gt, children: `Connect to Content` }),
			d(`p`, {
				style: Kt,
...
//# sourceMappingURL=IGVKsj4vh.CmwrySSI.mjs.map
