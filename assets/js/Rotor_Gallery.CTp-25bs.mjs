...
import { A as c, X as l, a as u } from "./framer.OLO5kSrG.mjs";
function d(e) {
	let {
			images: r = [],
			count: s = 8,
	...
	t(() => {
		...
		(r &&
			t !== T.current.w &&
			((e.style.width = `${t}px`), (T.current.w = t)),
			i &&
				n !== T.current.h &&
						...
						return i(
							`li`,
							{
								...
								style: {
									...
									"--radius": `${d}px`,
									"--imgrot": `${b}deg`,
									animationDelay: E ? n : void 0,
									"--bg-img": e ? `url(${e})` : `none`,
									"--bg-col": e ? `transparent` : c,
								},
							},
							t,
						);
	...
	(s(),
		...
		c(d, {
			images: {
				title: `Images`,
				type: u.Array,
				control: { type: u.Image },
			},
			count: { title: `Count`, type: u.Number, min: 1, max: 24, step: 1 },
			cardColor: { title: `Fallback`, type: u.Color },
			cardWidth: {
				title: `Card W`,
				type: u.Number,
				min: 50,
...
//# sourceMappingURL=Rotor_Gallery.CTp-25bs.mjs.map
