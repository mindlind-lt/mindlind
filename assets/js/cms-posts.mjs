...
function _(e, t, n, r) {
	(h(e >= t, e, `outside lower bound for`, r),
		h(e <= n, e, `outside upper bound for`, r));
}
function v(e) {
...
var w,
	...
	nt = e(() => {
		(c(),
			...
			(M = (e, t, n) => j(e, typeof t == `symbol` ? t : t + ``, n)),
			(qe = Ke(
				We({
...
` +
			...
			(Xe = class {
				...
				writeUint64(e) {
					_(e, R.Uint64, z.Uint64, `Uint64`);
					let t = BigInt(e);
					this.writeBigUint64(t);
				}
				writeBigUint64(e) {
					_(e, R.BigUint64, z.BigUint64, `BigUint64`);
					let t = N.BigUint64;
					(this.ensureLength(t),
				...
				writeInt64(e) {
					_(e, R.Int64, z.Int64, `Int64`);
					let t = BigInt(e);
					this.writeBigInt64(t);
				}
				writeBigInt64(e) {
					_(e, R.BigInt64, z.BigInt64, `BigInt64`);
					let t = N.BigInt64;
					(this.ensureLength(t),
			...
			(W = class {
				async loadModel() {
					...
					return (h(e, `Failed to load model`), V.deserialize(e));
				}
				async getModel() {
					return (
				...
				queryContains(e, t, n) {
					return this.findItems(e, n, (e) => {
						if (e?.type !== p.String || t.value?.type !== p.String)
							return !1;
						let n = e.value,
							r = t.value.value;
						return (
				...
				getLeftMost(e, t, n) {
					...
					for (; r < i; ) {
						let a = (r + i) >> 1,
							o = e[a].values[t];
						0 > w.compare(o, n, this.collation)
							? (r = a + 1)
							: (i = a);
					}
					return r;
				...
				getRightMost(e, t, n) {
					...
					for (; r < i; ) {
						let a = (r + i) >> 1,
							o = e[a].values[t];
						w.compare(o, n, this.collation) > 0
							? (i = a)
							: (r = a + 1);
					}
					return i - 1;
...
function rt(e) {
	return typeof e == `object` && !!e && !rIsValidElement(e) && ot in e;
}
function it(e, ...t) {
	if (!e)
		throw Error(
...
var K,
	...
	Rt = e(() => {
		(f(),
			...
			ct(),
			(q = {
				aCxyLQ1t8: { isNullable: !0, type: p.String },
				createdAt: { isNullable: !0, type: p.Date },
				CvhGKpfzb: { isNullable: !0, type: p.Enum },
				DcR7dZYg7: { isNullable: !0, type: p.Link },
				Fc9gMlpS8: {
					definition: { isNullable: !0, type: p.String },
					isNullable: !0,
					type: p.Array,
				},
				frSm7SqOH: { isNullable: !0, type: p.String },
				gBohv3AhW: { isNullable: !0, type: p.ResponsiveImage },
				HhZ9YcumA: { isNullable: !0, type: p.ResponsiveImage },
				id: { isNullable: !1, type: p.String },
				iPR_E15pa: { isNullable: !0, type: p.String },
				iprSlvcgS: { isNullable: !0, type: p.String },
				KuMrwvX4m: {
					definition: {
						definitions: {
							CzKJd55Q3: {
				...
				OZdNue_CD: { isNullable: !0, type: p.String },
				p8fxY0bCX: { isNullable: !0, type: p.VectorSetItem },
				PMkPNP5YT: { isNullable: !0, type: p.ResponsiveImage },
				previousItemId: { isNullable: !0, type: p.String },
				pXUZglhxh: { isNullable: !0, type: p.String },
				Rcd9YdMN_: { isNullable: !0, type: p.String },
				t9QzOmy7p: { isNullable: !0, type: p.ResponsiveImage },
				updatedAt: { isNullable: !0, type: p.Date },
				VSmb3sBiu: { isNullable: !0, type: p.String },
				XeBiPQ5VL: { isNullable: !0, type: p.ResponsiveImage },
			}),
			(lt = [`id`]),
			(J = { type: 1 }),
			(ut = [`previousItemId`]),
					...
					default: new tt({
						chunks: [
							new URL(
								...
								`https://framerusercontent.com/modules/vUm2Jz4zpFvATcaK29ql/MRiV6lN5OQXMZtto4HRY/tTTLfmF7I.js`,
			...
			u(Z, {
				...
				frSm7SqOH: { title: `Slug`, type: p.String },
				iprSlvcgS: {
					defaultValue: ``,
					displayTextArea: !0,
					title: `Description`,
				...
				DcR7dZYg7: { title: `Link to Website`, type: p.Link },
				Fc9gMlpS8: {
				...
				PMkPNP5YT: { title: `QR-Code Image`, type: p.ResponsiveImage },
				OZdNue_CD: {
					defaultValue: ``,
					title: `Video URL`,
					type: p.String,
					...
					let [n] = await X.get(
						{
							...
							select: [{ name: `frSm7SqOH`, type: `Identifier` }],
							where: {
					...
					let [n] = await X.get(
						{
							...
							where: {
								left: { name: `frSm7SqOH`, type: `Identifier` },
								operator: `==`,
								right: { type: `LiteralValue`, value: e },
								type: `BinaryOperation`,
							},
				...
				exports: {
					...
					default: {
						...
						annotations: {
							...
							framerSlug: `frSm7SqOH`,
							framerCollectionUtils: `1`,
							framerCollectionId: `tTTLfmF7I`,
							framerRecordIdKey: `id`,
						},
					},
					CvhGKpfzbToDisplayName: {
						type: `variable`,
						annotations: { framerContractVersion: `1` },
					},
