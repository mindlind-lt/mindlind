...
async function He(e) {
	let t = Math.floor(Ye * (Math.random() + 1) * 2 ** (e - 1));
	await new Promise((e) => {
		setTimeout(e, t);
	});
}
...
` +
			...
			(qe = class {
				...
				ensureLength(e) {
					...
					let n = new Uint8Array(Math.ceil(t * L) + e);
			...
			(G = async (e, t) => {
				...
				for (;;) {
					try {
						...
						if (!Xe.includes(r.status) || ++n > W) return r;
					} catch (e) {
			...
			(K = class {
				async loadModel() {
					...
					return (h(e, `Failed to load model`), Je.deserialize(e));
				}
				async getModel() {
					return (
	...
	Ot = e(() => {
		(f(),
			...
			(Y = {
				...
				DmIfvWJXK: { isNullable: !0, type: p.String },
				Eq05S6sQ_: { isNullable: !0, type: p.String },
				id: { isNullable: !1, type: p.String },
				jQUyHezL3: { isNullable: !0, type: p.Date },
				nextItemId: { isNullable: !0, type: p.String },
				oeVdX_wT7: { isNullable: !0, type: p.String },
				previousItemId: { isNullable: !0, type: p.String },
				RXbR2n5hz: { isNullable: !0, type: p.RichText },
				tUjGhFa0z: { isNullable: !0, type: p.ResponsiveImage },
				u3FsyzNM_: { isNullable: !0, type: p.Boolean },
				updatedAt: { isNullable: !0, type: p.Date },
				Xk3s85B2e: { isNullable: !0, type: p.String },
			}),
			(st = [`id`]),
			(X = { type: 1 }),
			(ct = [`previousItemId`]),
			...
			($ = {
				collectionByLocaleId: {
					default: new $e({
						chunks: [
							new URL(
								`./iOnt4WyqW-chunk-default-0.framercms`,
								`https://framerusercontent.com/modules/88qp3bn2wJ8HeNvj7wT5/x9eZeYJOh7WieuJxzk28/iOnt4WyqW.js`,
							).href.replace(`/modules/`, `/cms/`),
						],
						id: `f81d8d7d-afd4-4569-b042-3522823196afdefault`,
						indexes: [
							new K({
								collation: X,
								collectionSchema: Y,
								...
								range: { from: 0, to: 121 },
								url: new URL(
									`./iOnt4WyqW-indexes-default-0.framercms`,
									`https://framerusercontent.com/modules/88qp3bn2wJ8HeNvj7wT5/x9eZeYJOh7WieuJxzk28/iOnt4WyqW.js`,
								).href.replace(`/modules/`, `/cms/`),
							}),
							new K({
						...
						resolveRichText: Ct,
						resolveVectorSetItem: St,
						schema: Y,
					}),
				},
				displayName: `Blog`,
				id: `f81d8d7d-afd4-4569-b042-3522823196af`,
			}),
			(wt = $),
			u($, {
				Xk3s85B2e: {
				...
				oeVdX_wT7: { title: `Slug`, type: p.String },
				jQUyHezL3: { title: `Date`, type: p.Date },
				RXbR2n5hz: {
					defaultValue: ``,
					title: `Content`,
					type: p.RichText,
				},
				tUjGhFa0z: { title: `Main Image`, type: p.ResponsiveImage },
				AZrA2zOaE: {
					__vekterDefault: [],
					control: {
						controls: {
				...
				previousItemId: {
					dataIdentifier: `local-module:collection/iOnt4WyqW:default`,
					title: `Previous`,
					type: p.CollectionReference,
				},
				nextItemId: {
					...
					let [n] = await Q.get(
						{
							...
							select: [{ name: `oeVdX_wT7`, type: `Identifier` }],
							where: {
					...
					let [n] = await Q.get(
						{
							...
							where: {
								left: { name: `oeVdX_wT7`, type: `Identifier` },
								operator: `==`,
								right: { type: `LiteralValue`, value: e },
								type: `BinaryOperation`,
							},
