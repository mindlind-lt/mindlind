...
import { N as d, S as f, t as p } from "./motion.VNkKVxJm.mjs";
import { A as m, X as h, a as g, w as _ } from "./framer.OLO5kSrG.mjs";
function v(e) {
...
function T(e, t) {
	if (!(!e || o === void 0))
		try {
			let n = new URL(e, o.location.href).toString();
			t
				? o.open(n, `_blank`, `noopener,noreferrer`)
				: o.location.assign(n);
		} catch (t) {
...
function E(e) {
	let {
			...
			revealEase: D = `out`,
			intensity: O = 1,
			charset: k = `ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$%*`,
			hoverOnly: A = !0,
			repeatOnHover: j = !0,
			repeatOnEnter: M = !1,
			style: te = {},
	...
	let q = _.current() === _.canvas,
		...
		X = r(() => {
			...
			let e = Math.max(1, Math.round((g / 1e3) * E)),
				t = Array(e);
			for (let n = 0; n < e; n++) t[n] = b((n + 1) / e, D);
			let n = U.split(``),
				r = Array(W),
				i = new Uint16Array(G);
			y(i);
				...
				o = () => {
					...
					(V(r.join(``)),
						...
						a < e
							...
							: (V(U), (J.current = !1), (Y.current = null)));
				};
			Y.current = requestAnimationFrame(o);
		}, [U, W, G, K, g, E, D, O]),
		Z = r(() => {
...
var D = e(() => {
	(u(),
		...
		m(E, {
			...
			color: { type: g.Color, title: `Color`, defaultValue: `#111111` },
			link: { type: g.Link ?? g.String, title: `Link`, defaultValue: `` },
			newTab: {
				type: g.Boolean,
...
//# sourceMappingURL=Text_Hover_Random.D90ASV3e.mjs.map
