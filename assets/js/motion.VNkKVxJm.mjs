import { r as e, t } from "./rolldown-runtime.DsXBSD_B.mjs";
import {
	A as n,
	B as r,
	C as i,
		...
		h = () => {
			...
			((n = !1),
				a ||
					(i.delta = r
						? 1e3 / 60
						: Math.max(Math.min(o - i.timestamp, uc), 1)),
				(i.timestamp = o),
				(i.isProcessing = !0),
				s.process(i),
				c.process(i),
...
function We(e) {
	return (
		isNaN(e) &&
		typeof e == `string` &&
		(e.match(Cc)?.length || 0) + (e.match(Lc)?.length || 0) > 0
	);
}
function Ge(e) {
	let t = e.toString(),
...
function Ye(e) {
	let t = Ge(e);
	return qe(t)(t.values.map((e, n) => Gc(e, t.split[n])));
}
function Xe(e, t, n) {
	return (
		n < 0 && (n += 1),
	...
	if (h < 1)
		((x = lt(_, h)),
			...
			(y = (e) =>
				o -
				Math.exp(-h * _ * e) *
					(S * Math.sin(x * e) + g * Math.cos(x * e))),
			(C = h * _ * S + g * x),
			(w = h * _ * g - S * x),
			(b = (e) =>
				Math.exp(-h * _ * e) *
				(C * Math.sin(x * e) + w * Math.cos(x * e))));
	else if (h === 1) {
		...
		(t.forEach((e) => {
			...
			e.forEach((e) => {
				e.suspendedScrollY !== void 0 &&
					p.scrollTo(0, e.suspendedScrollY);
			}));
	}
...
function Ht(e) {
	typeof e.ease == `string` && Vt(e.ease) && (e.ease = zl[e.ease]);
}
function Ut(e) {
...
function Wt(e) {
	for (let t = 0; t < e.length; t++)
		if (typeof e[t] == `string` && Ul.test(e[t])) return !0;
	return !1;
}
function Gt(e) {
	let {
...
function Zt(e, t, n = 1) {
	...
	let [r, i] = Xt(e);
	if (!r) return;
	let a = p.getComputedStyle(t).getPropertyValue(r);
	if (a) {
		let e = a.trim();
		return Is(e) ? parseFloat(e) : e;
	}
	return _c(i) ? Zt(i, t, n + 1) : i;
}
function Qt(e, t) {
	if (e?.inherit && t) {
		let { inherit: n, ...r } = e;
...
function sn(e, t) {
	...
	for (let t in ((i = { ...i, ...n }), i)) an(e, t, on(i[t]));
}
function cn(e) {
	return !!(X(e) && e.add);
}
...
function pn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
	...
	for (let t in s) {
		...
		if (p.MotionHandoffAnimation) {
			let n = dn(e);
			if (n) {
				let e = p.MotionHandoffAnimation(n, t, B);
				e !== null && ((o.startTime = e), (f = !0));
			}
		}
		ln(e, t);
		let m = l ?? e.shouldReduceMotion;
		r.start(au(t, r, i, m && ou.has(t) ? { type: !1 } : o, e, f));
		let h = r.animation;
		h && u.push(h);
	}
	if (o) {
	...
	return (
		r.forEach((e) => {
			let n = !1,
				...
				c = (e) => {
					((n = !1),
						p.removeEventListener(`pointerup`, c),
						p.removeEventListener(`pointercancel`, c),
						r && ((r = !1), s(e)));
				},
				l = () => {
					((n = !0),
						p.addEventListener(`pointerup`, c, i),
						p.addEventListener(`pointercancel`, c, i));
				},
				u = (e) => {
...
function Nn(e, t, n = {}) {
	let [r, i, a] = Tn(e, n),
		o = (e) => {
			...
			if (!Mn(e) || Ru.has(e)) return;
			(Iu.add(r), n.stopPropagation && Ru.add(e));
			let a = t(r, e),
				o = (e, t) => {
					(p.removeEventListener(`pointerup`, s),
						p.removeEventListener(`pointercancel`, c),
			...
			(p.addEventListener(`pointerup`, s, i),
				p.addEventListener(`pointercancel`, c, i));
		};
	return (
		r.forEach((e) => {
			((n.useGlobalTarget ? p : e).addEventListener(`pointerdown`, o, i),
				Sn(e) &&
...
function Ln() {
	typeof ResizeObserver > `u` || (Bu = new ResizeObserver(In));
}
function Rn(e, t) {
	Bu || Ln();
	let n = xn(e);
	...
	return (
		...
		() => {
			(Wu.delete(e),
				!Wu.size &&
					typeof Gu == `function` &&
					(p.removeEventListener(`resize`, Gu), (Gu = void 0)));
		}
	);
}
function Vn(e, t) {
...
function qn(e, t, n = {}) {
	...
	if (
		(e.attach((e, t) => {
			((a = e), (o = (e) => t(Jn(e, s))), B.postRender(u));
		}, c),
		X(t))
	) {
...
function _r(e, { x: t, y: n }) {
	(gr(e.x, t.translate, t.scale, t.originPoint),
		gr(e.y, n.translate, n.scale, n.originPoint));
}
	...
	for (let s = 0; s < i; s++) {
		...
		(i && i.props.style && i.props.style.display === `contents`) ||
			(r &&
				...
				a.scroll &&
				a !== a.root &&
				(yr(e.x, -a.scroll.offset.x), yr(e.y, -a.scroll.offset.y)),
			o && ((t.x *= o.x.scale), (t.y *= o.y.scale), _r(e, o)),
			r &&
				dr(a.latestValues) &&
				Sr(e, a.latestValues, a.layout?.layoutBox));
	}
...
function Er(e, t, n) {
	...
	if (
		(t.transform ||
			(o || n
				? (r.transform = Tr(t, e.transform, n))
				: (r.transform &&= `none`)),
		s)
	) {
...
function Ir(e, t, n, r) {
	for (let n in (Dr(e, t, void 0, r), t.attrs))
		e.setAttribute(bd.has(n) ? n : un(n), t.attrs[n]);
}
function Lr(e, t, n) {
	let r = jr(e, t, n);
	for (let n in e)
...
function Br(e) {
	return (t) =>
		Promise.all(t.map(({ animation: t, options: n }) => gn(e, t, n)));
}
function Vr(e) {
	let t = Br(e),
		n = Wr(),
...
function Jr(e, t, n, r = 0.5) {
	((e.origin = r),
		...
		((e.translate >= Ad && e.translate <= jd) || isNaN(e.translate)) &&
			(e.translate = 0));
}
function Yr(e, t, n, r) {
...
function Xr(e, t, n, r = 0) {
	((e.min = (r ? J(n.min, n.max, r) : n.min) + t.min),
		(e.max = e.min + A(t)));
}
function Zr(e, t, n, r) {
...
function ti(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
	...
	(e === a && (s -= t),
		(e.min = ei(e.min, t, n, s, i)),
		(e.max = ei(e.max, t, n, s, i)));
}
...
function pi(e, t, n, r, i, a) {
	i
		? ((e.opacity = J(0, n.opacity ?? 1, Rd(r))),
			(e.opacityExit = J(t.opacity ?? 1, 0, zd(r))))
...
function xi(e) {
	...
	if (p.MotionHasOptimisedAnimation(n, `transform`)) {
		...
		p.MotionCancelOptimisedAnimation(n, `transform`, B, !(t || r));
	}
	let { parent: r } = e;
...
function Si({
	...
	return class {
			...
			((this.id = qd++),
				...
				(this.updateProjection = () => {
					((this.projectionUpdateScheduled = !1),
						z.value &&
							(Wd.nodes =
								Wd.calculatedTargetDeltas =
								Wd.calculatedProjections =
									0),
		...
		addEventListener(e, t) {
			return (
				this.eventHandlers.has(e) ||
					this.eventHandlers.set(e, new Vs()),
		...
		willUpdate(e = !0) {
			...
			if (
				(p.MotionCancelOptimisedAnimation &&
		...
		measurePageBox() {
			...
			if (!(this.scroll?.wasRoot || this.path.some(Gi))) {
				...
				e && (yr(t.x, e.offset.x), yr(t.y, e.offset.y));
			}
			return t;
		}
		...
		applyTransform(e, t = !1, n) {
			...
			for (let e = 0; e < this.path.length; e++) {
				...
				(!t &&
					...
					n.scroll &&
					n !== n.root &&
					(yr(r.x, -n.scroll.offset.x), yr(r.y, -n.scroll.offset.y)),
					dr(n.latestValues) &&
						Sr(r, n.latestValues, n.layout?.layoutBox));
			}
			return (
				dr(this.latestValues) &&
					Sr(r, this.latestValues, this.layout?.layoutBox),
				r
			);
		}
		removeTransform(e) {
			...
			for (let e = 0; e < this.path.length; e++) {
				...
				let r;
				(n.instance &&
					(ur(n.latestValues) && n.updateSnapshot(),
					(r = Q()),
					k(r, n.measurePageBox())),
					ri(t, n.latestValues, n.snapshot?.layoutBox, r));
			}
			return (dr(this.latestValues) && ri(t, this.latestValues), t);
		}
		setTargetDelta(e) {
			((this.targetDelta = e),
			...
			((this.mixTargetDelta = (t) => {
				...
				(Ri(a.x, e.x, n),
					...
					this.relativeTarget &&
						...
						d &&
							si(this.relativeTarget, d) &&
							(this.isProjectionDirty = !1),
						(d ||= Q()),
						k(d, this.relativeTarget)),
					s &&
						((this.animationValues = i),
						pi(i, r, this.latestValues, n, u, l)),
					this.root.scheduleUpdateProjection(),
					this.scheduleRender(),
		...
		finishAnimation() {
			(this.currentAnimation &&
				(this.mixTargetDelta && this.mixTargetDelta(Kd),
				this.currentAnimation.stop()),
				this.completeAnimation());
		}
		...
		applyProjectionStyles(e, t) {
			...
			this.options.layoutId &&
				(e.pointerEvents =
					r === this ? yi(t?.pointerEvents) || `` : `none`);
		}
		clearSnapshot() {
...
function wi(e) {
	...
	if (e.isLead() && e.layout && t && e.hasListeners(`didUpdate`)) {
		...
		let s = Yu();
		a
			? Yr(s, e.applyTransform(r, !0), t.measuredBox)
			: Yr(s, n, t.layoutBox);
		let c = !ai(o),
			l = !1;
		if (!e.resumeFrom) {
...
function Wi(e, t, n) {
	return (
		e === `position` || (e === `preserve-aspect` && !qr(ui(t), ui(n), 0.2))
	);
}
function Gi(e) {
...
function Xi({
	...
	let s = T(),
		c = y(null),
		l = y({ width: 0, height: 0, top: 0, left: 0, right: 0, bottom: 0 }),
		{ nonce: u } = v($),
		d = Yi(c, e.props?.ref ?? e?.ref);
	return (
		w(() => {
			let {
				width: e,
...
function ca({ children: e, isValidProp: t, ...n }) {
	...
	let r = v($);
	((n = { ...r, ...n }),
		(n.transition = Qt(n.transition, r.transition)),
...
function da(e, t) {
	if (er(e)) {
		...
		return {
			...
			animate: $n(n) ? n : void 0,
		};
	}
	return e.inherit === !1 ? {} : t;
}
function fa(e) {
	let { initial: t, animate: n } = da(e, v(hf));
	return l(() => ({ initial: t, animate: n }), [pa(t), pa(n)]);
}
function pa(e) {
...
function va(e, t, n, r) {
	let i = l(() => {
		let n = yf();
		return (
			Fr(n, t, xd(r), e.transformTemplate, e.style),
...
function ba(e, t, n, { latestValues: r }, i, a = !1, s) {
	let c = ((s ?? ya(e)) ? va : _a)(t, r, i, e),
		u = sa(t, typeof e == `string`, a),
		d = e === o ? {} : { ...u, ...c, ref: n },
		{ children: f } = t,
		p = l(() => (X(f) ? f.get() : f), [f]);
...
function Ca(e, t, n, r, i, a) {
	...
	let b = y(!1);
	w(() => {
		g && b.current && g.update(n, c);
	});
	let x = n[pu],
		S = y(
			!!x &&
				p !== void 0 &&
				!p.MotionHandoffIsComplete?.(x) &&
				p.MotionHasOptimisedAnimation?.(x),
		);
	return (
		Ns(() => {
			((h.current = !0),
		...
		d(() => {
			g &&
				...
				(S.current &&=
					(queueMicrotask(() => {
						p.MotionHandoffMarkAsComplete?.(x);
					}),
					!1)),
...
function wa(e, t, n, r) {
	...
	((e.projection = new n(
		e.latestValues,
		t[`data-framer-portal-id`] ? void 0 : Ta(e.parent),
	)),
...
function Ta(e) {
	if (e)
		return e.options.allowProjection === !1 ? Ta(e.parent) : e.projection;
}
function Ea(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
	...
	function s(n, s) {
		...
		if (!u && p !== void 0) {
			...
			let t = ka(l);
			((c = t.MeasureLayout),
				(d.visualElement = Ca(e, f, l, i, t.ProjectionNode, a)));
		}
		return b(hf.Provider, {
			value: d,
			children: [
				c && d.visualElement
					? m(c, { visualElement: d.visualElement, ...l })
					: null,
...
function Aa(e, t) {
	...
	return new Proxy((e, t) => r(e, t), {
		get: (i, a) =>
			a === `create`
				? r
				: (n.has(a) || n.set(a, Ea(a, void 0, e, t)), n.get(a)),
	});
}
function ja(e) {
...
function Ga(e, t) {
	...
	return (
		i > r
			? (n = Bs(t.min, t.max - r, e.min))
			: r > i && (n = Bs(e.min, e.max - i, t.min)),
		N(0, 1, n)
	);
}
function Ka(e, t) {
...
function go(
	...
	if ((i.add(a), !up.has(t))) {
		...
		(p.addEventListener(`resize`, r),
			t !== document.documentElement && dp.set(t, Vn(t, r)),
...
function ko(e, t) {
	return p === void 0 ? !1 : e ? Pl() && !!xo(t) : Nl();
}
	...
	let e = !1,
		...
		n = {
			...
			start(n, r) {
				...
				return (
					t.forEach((e) => {
						i.push(gn(e, n, { transitionOverride: r }));
					}),
					Promise.all(i)
				);
			},
...
function Zo(e, t, n, r, i, a) {
	...
	for (let o = 0; o < t.length; o++)
		e.push({ value: t[o], at: J(i, a, r[o]), easing: Le(n, o) });
}
function Qo(e, t) {
	...
	for (let n = 0; n < e.length; n++) {
		...
		let g = 0,
			_ = (e, n, r, o = 0, s = 0) => {
				...
				if ((T > 0 && yt(u, T), c.length === 1 && c.unshift(null), m)) {
					(P(
						m < Cp,
...
function cs(e, t, n, r) {
	let i = [];
	if (ss(e, t))
		i.push(gi(e, (Ko(t) && t.default) || t, n && (n.default || n)));
	else {
		if (e == null) return i;
		let a = qo(e, t, r),
			o = a.length;
...
function gs(e) {
	$d.current &&
		(($d.current.isUpdating = !1), $d.current.blockUpdate(), e && e());
}
function _s() {
	return u(() => {
		let e = $d.current;
...
function xs(e, t, n, r) {
	...
	let s = e[i],
		c = o.layout,
		l = J(c.min, c.max, 0.5);
	return (a === 1 && s.layout.max + n > l) ||
		(a === -1 && s.layout.min + n < l)
		? je(e, i, i + a)
		: e;
}
function Ss(
...
function Ds(e, t, n) {
	let r = t.getBoundingClientRect(),
		...
		a =
			n === `x`
				? Math.min(p.innerWidth, r.right)
				: Math.min(p.innerHeight, r.bottom),
		o = e - i,
		s = a - e;
	if (o < Np) {
		let e = 1 - o / Np;
...
function Os(e, t, n, r) {
	...
	let i = Es(e, n);
	if (!i) return;
	let { amount: a, edge: o } = Ds(
		t - (n === `x` ? p.scrollX : p.scrollY),
		i,
		n,
	);
	if (o === null) {
	...
	if (s !== o) {
		...
		let e =
			n === `x`
				? i.scrollWidth - (c ? p.innerWidth : i.clientWidth)
				: i.scrollHeight - (c ? p.innerHeight : i.clientHeight);
		Ip.set(i, e);
	}
	if (a > 0) {
		let e = Ip.get(i);
		...
		(E(),
			...
			(U = {
				now: () => (
					fc === void 0 &&
						U.set(
							H.isProcessing || F.useManualTiming
								? H.timestamp
								: performance.now(),
						),
					fc
			...
			(Zc = (e, t) => {
				...
				return r.indexes.var.length === i.indexes.var.length &&
					...
					? (Xc.has(e) && !i.values.length) ||
						(Xc.has(t) && !r.values.length)
						? et(e, t)
			...
			(ul = class extends cl {
				...
				initAnimation() {
					...
					s !== Ct &&
						typeof o[0] != `number` &&
						((this.mixKeyframes = zs(ll, ot(o[0], o[1]))),
						(o = [0, 100]));
				...
				tick(e, t = !1) {
					...
					let S =
						this.holdTime === null &&
						(this.state === `finished` ||
							(this.state === `running` && x));
					return (
						S &&
							p !== gt &&
							(b.value = wt(l, this.options, h, this.speed)),
						m && m(b.value),
						S && this.finish(),
						b
					);
			...
			(jl = (e) => e.startsWith(`--`)),
			(Ml = {}),
			(Nl = It(() => p.ScrollTimeline !== void 0, `scrollTimeline`)),
			(Pl = It(() => p.ViewTimeline !== void 0, `viewTimeline`)),
			(Fl = It(() => {
				try {
					document
						.createElement(`div`)
			...
			(Rl = class extends cl {
				...
				get startTime() {
					return (
						this.manualStartTime ?? Number(this.animation.startTime)
					);
				}
				set startTime(e) {
			...
			(Jl = class extends cl {
				...
				onKeyframesResolved(e, t, n, r) {
					...
					let d = {
							startTime: r
								? this.resolvedAt &&
									this.resolvedAt - this.createdAt > ql
									? this.resolvedAt
									: this.createdAt
								: void 0,
							finalKeyframe: t,
					...
					(m.finished
						...
						(this.pendingTimeline &&=
							((this.stopTimeline = m.attachTimeline(
								this.pendingTimeline,
							)),
							void 0)),
						(this._animation = m));
				...
				get animation() {
					return (
						this._animation ||
							(this.keyframeResolver?.resume(), Pt()),
						this._animation
					);
				}
				get duration() {
			...
			(Ou = class extends Al {
				...
				measureInitialState() {
					...
					(n === `height` && (this.suspendedScrollY = p.pageYOffset),
						(this.measuredOrigin = Tl[n](
							e.measureViewportBox(),
							p.getComputedStyle(e.current),
						)),
			...
			({ schedule: Au, cancel: ju } = ze(queueMicrotask, !1)),
			(Z = { x: !1, y: !1 }),
			...
			(Lu = (e, t) => {
				...
				let r = An(() => {
					...
					(n.addEventListener(`keyup`, e, t),
						n.addEventListener(`blur`, () => jn(n, `cancel`), t));
				});
			...
			(ad = class {
					...
					((this.current = e),
						...
						this.reducedMotionConfig === `never`
							...
							: this.reducedMotionConfig === `always`
								...
								: (td.current || rr(),
									(this.shouldReduceMotion = ed.current)),
						(this.shouldSkipAnimations =
							this.skipAnimationsConfig ?? !1),
				...
				bindToMotionValue(e, t) {
					...
					let r = t.on(`change`, (t) => {
						...
						i;
					(p !== void 0 &&
						p.MotionCheckAppearSync &&
						(i = p.MotionCheckAppearSync(this, e, t)),
						this.valueSubscriptions.set(e, () => {
			...
			(hd = class extends od {
				constructor() {
					(super(...arguments),
						(this.type = `html`),
						(this.renderInstance = Dr));
				}
				readValueFromInstance(e, t) {
					if (xl.has(t))
						return this.projection?.isProjecting ? Ot(t) : yl(e, t);
					{
						let n = Mr(e),
			...
			(Vd = class {
				...
				forEach(e) {
					(this.isDirty && this.children.sort(Bd),
						(this.isDirty = !1),
			...
			(Hd = class {
				...
				scheduleRender() {
					this.members.forEach(
						(e) => e.instance && e.scheduleRender(!1),
					);
				}
				removeLeadSnapshot() {
			...
			(Yd = (e) =>
				r !== void 0 &&
				r.userAgent &&
				r.userAgent.toLowerCase().includes(e)),
			...
			(ef = Si({
				...
				checkIsScrollRoot: (e) =>
					p.getComputedStyle(e).position === `fixed`,
			})),
			...
			(nf = ({
				...
				return (
					...
					m(Ps.Provider, { value: g, children: e })
				);
			}),
			(rf = (e) => e.key || ``),
			(af = ({
				...
				let [f, p] = Qi(o),
					...
					[E, ee] = s(h);
				Ns(() => {
					((_.current = !1), (b.current = h));
					for (let e = 0; e < E.length; e++) {
						let t = rf(E[e]);
						g.includes(t)
							? (x.delete(t), C.current.delete(t))
							: x.get(t) !== !0 && x.set(t, !1);
					}
				}, [E, g.length, g.join(`-`)]);
				let D = [];
				...
				let { forceRender: te } = v(js);
				return m(S, {
					children: E.map((e) => {
						let s = rf(e),
							l = o && !f ? !1 : h === E || g.includes(s);
						return m(
							nf,
							{
								isPresent: l,
			...
			(lf = ({ children: e, id: t, inherit: n = !0 }) => {
				...
				s.current === null &&
					(cf(n) && c && (t = t ? c + `-` + t : c),
					(s.current = { id: t, group: (sf(n) && r.group) || Ki() }));
			...
			(mf = (e) => !aa(e)));
		try {
			oa(le(`@emotion/is-prop-valid`).default);
		} catch {}
		((hf = c({})),
			(gf = (e) => (t, n) => {
				let r = v(hf),
			...
			(Nf = class {
				...
				startScrollTracking(e) {
					...
					(this.scrollPositions.set(p, {
						x: p.scrollX,
						y: p.scrollY,
					}),
						p.addEventListener(`scroll`, this.onElementScroll, {
							capture: !0,
						}),
						p.addEventListener(`scroll`, this.onWindowScroll),
			...
			(If = class {
				...
				start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
					...
					let i = (e) => {
							(t && this.snapToCursor(ja(e).point),
								this.stopAnimation());
						},
						a = (e, t) => {
							let {
				...
				startAxisValueAnimation(e, t) {
					...
					return (
						ln(this.visualElement, e),
						n.start(au(e, n, 0, t, this.visualElement, !1))
					);
				}
				stopAnimation() {
			...
			(Hf = {
				pan: { Feature: zf },
				drag: { Feature: Lf, ProjectionNode: ef, MeasureLayout: eo },
			}),
			(Uf = class extends sd {
				mount() {
			...
			(Zf = class extends sd {
				...
				update() {
					...
					[`amount`, `margin`, `root`].some(ao(e, t)) &&
						this.startObserver();
				}
				unmount() {
					(this.stopObserver?.(),
			...
			(pp = new WeakMap()),
			(mp = new WeakMap()),
			(hp = (e) => (e === document.scrollingElement ? p : e)),
			(gp = [
				[cp.Enter, `entry`],
				[cp.Exit, `exit`],
				[cp.Any, `cover`],
...
//# sourceMappingURL=motion.VNkKVxJm.mjs.map
